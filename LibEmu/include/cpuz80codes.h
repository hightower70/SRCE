...
case ADD_xHL:  I= cpuMemRead(R->HL.W);M_ADD(I);break;
...
case SUB_xHL:  I=cpuMemRead(R->HL.W);M_SUB(I);break;
...
case AND_xHL:  I=cpuMemRead(R->HL.W);M_AND(I);break;
...
case OR_xHL:   I=cpuMemRead(R->HL.W);M_OR(I);break;
...
case ADC_xHL:  I=cpuMemRead(R->HL.W);M_ADC(I);break;
...
case SBC_xHL:  I=cpuMemRead(R->HL.W);M_SBC(I);break;
...
case XOR_xHL:  I=cpuMemRead(R->HL.W);M_XOR(I);break;
...
case CP_xHL:   I=cpuMemRead(R->HL.W);M_CP(I);break;
...
case DEC_xHL:  I=cpuMemRead(R->HL.W);M_DEC(I);cpuMemWrite(R->HL.W,I);break;
...
case INC_xHL:  I=cpuMemRead(R->HL.W);M_INC(I);cpuMemWrite(R->HL.W,I);break;
...
case LD_xHL_B: cpuMemWrite(R->HL.W,R->BC.B.h);break;
...
case LD_xHL_C: cpuMemWrite(R->HL.W,R->BC.B.l);break;
...
case LD_xHL_D: cpuMemWrite(R->HL.W,R->DE.B.h);break;
...
case LD_xHL_E: cpuMemWrite(R->HL.W,R->DE.B.l);break;
...
case LD_xHL_H: cpuMemWrite(R->HL.W,R->HL.B.h);break;
...
case LD_xHL_L: cpuMemWrite(R->HL.W,R->HL.B.l);break;
...
case LD_xHL_A: cpuMemWrite(R->HL.W,R->AF.B.h);break;

case LD_xBC_A: cpuMemWrite(R->BC.W,R->AF.B.h);break;
case LD_xDE_A: cpuMemWrite(R->DE.W,R->AF.B.h);break;

case LD_B_xHL:    R->BC.B.h=cpuMemRead(R->HL.W);break;
case LD_C_xHL:    R->BC.B.l=cpuMemRead(R->HL.W);break;
case LD_D_xHL:    R->DE.B.h=cpuMemRead(R->HL.W);break;
case LD_E_xHL:    R->DE.B.l=cpuMemRead(R->HL.W);break;
case LD_H_xHL:    R->HL.B.h=cpuMemRead(R->HL.W);break;
case LD_L_xHL:    R->HL.B.l=cpuMemRead(R->HL.W);break;
case LD_A_xHL:    R->AF.B.h=cpuMemRead(R->HL.W);break;
...
case LD_xHL_BYTE: cpuMemWrite(R->HL.W,OpZ80(R->PC.W++));break;

case LD_xWORD_HL:
  J.B.l=OpZ80(R->PC.W++);
  J.B.h=OpZ80(R->PC.W++);
  cpuMemWrite(J.W++,R->HL.B.l);
  cpuMemWrite(J.W,R->HL.B.h);
  break;

case LD_HL_xWORD:
  J.B.l=OpZ80(R->PC.W++);
  J.B.h=OpZ80(R->PC.W++);
  R->HL.B.l=cpuMemRead(J.W++);
  R->HL.B.h=cpuMemRead(J.W);
  break;
...
case EX_HL_xSP:
  J.B.l=cpuMemRead(R->SP.W);cpuMemWrite(R->SP.W++,R->HL.B.l);
  J.B.h=cpuMemRead(R->SP.W);cpuMemWrite(R->SP.W--,R->HL.B.h);
  R->HL.W=J.W;
  break;
