...
case ADD_xHL:  I=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));
               M_ADD(I);break;
...
case SUB_xHL:  I=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));
               M_SUB(I);break;
...
case AND_xHL:  I=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));
               M_AND(I);break;
...
case OR_xHL:   I=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));
               M_OR(I);break;
...
case ADC_xHL:  I=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));
               M_ADC(I);break;
...
case SBC_xHL:  I=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));
               M_SBC(I);break;
...
case XOR_xHL:  I=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));
               M_XOR(I);break;
...
case CP_xHL:   I=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));
               M_CP(I);break;
...
case LD_A_xBC: R->AF.B.h=cpuMemRead(R->BC.W);break;
case LD_A_xDE: R->AF.B.h=cpuMemRead(R->DE.W);break;
...
case DEC_xHL:  I=cpuMemRead(R->XX.W+(offset)cpuMemRead(R->PC.W));M_DEC(I);
               cpuMemWrite(R->XX.W+(offset)OpZ80(R->PC.W++),I);
               break;
...
case INC_xHL:  I=cpuMemRead(R->XX.W+(offset)cpuMemRead(R->PC.W));M_INC(I);
               cpuMemWrite(R->XX.W+(offset)OpZ80(R->PC.W++),I);
               break;
...
case NOP:  break;
case OUTA: I=OpZ80(R->PC.W++);cpuOut(I|(R->AF.W&0xFF00),R->AF.B.h);break;
case INA:  I=OpZ80(R->PC.W++);R->AF.B.h=cpuIn(I|(R->AF.W&0xFF00));break;
...
case LD_xHL_B: J.W=R->XX.W+(offset)OpZ80(R->PC.W++);
               cpuMemWrite(J.W,R->BC.B.h);break;
...
case LD_xHL_C: J.W=R->XX.W+(offset)OpZ80(R->PC.W++);
               cpuMemWrite(J.W,R->BC.B.l);break;
...
case LD_xHL_D: J.W=R->XX.W+(offset)OpZ80(R->PC.W++);
               cpuMemWrite(J.W,R->DE.B.h);break;
...
case LD_xHL_E: J.W=R->XX.W+(offset)OpZ80(R->PC.W++);
               cpuMemWrite(J.W,R->DE.B.l);break;
...
case LD_xHL_H: J.W=R->XX.W+(offset)OpZ80(R->PC.W++);
               cpuMemWrite(J.W,R->HL.B.h);break;
...
case LD_xHL_L: J.W=R->XX.W+(offset)OpZ80(R->PC.W++);
               cpuMemWrite(J.W,R->HL.B.l);break;
...
case LD_xHL_A: J.W=R->XX.W+(offset)OpZ80(R->PC.W++);
               cpuMemWrite(J.W,R->AF.B.h);break;

case LD_xBC_A: cpuMemWrite(R->BC.W,R->AF.B.h);break;
case LD_xDE_A: cpuMemWrite(R->DE.W,R->AF.B.h);break;

case LD_B_xHL:    R->BC.B.h=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));break;
case LD_C_xHL:    R->BC.B.l=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));break;
case LD_D_xHL:    R->DE.B.h=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));break;
case LD_E_xHL:    R->DE.B.l=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));break;
case LD_H_xHL:    R->HL.B.h=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));break;
case LD_L_xHL:    R->HL.B.l=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));break;
case LD_A_xHL:    R->AF.B.h=cpuMemRead(R->XX.W+(offset)OpZ80(R->PC.W++));break;
...
case LD_xHL_BYTE: J.W=R->XX.W+(offset)OpZ80(R->PC.W++);
                  cpuMemWrite(J.W,OpZ80(R->PC.W++));break;

case LD_xWORD_HL:
  J.B.l=OpZ80(R->PC.W++);
  J.B.h=OpZ80(R->PC.W++);
  cpuMemWrite(J.W++,R->XX.B.l);
  cpuMemWrite(J.W,R->XX.B.h);
  break;

case LD_HL_xWORD:
  J.B.l=OpZ80(R->PC.W++);
  J.B.h=OpZ80(R->PC.W++);
  R->XX.B.l=cpuMemRead(J.W++);
  R->XX.B.h=cpuMemRead(J.W);
  break;

case LD_A_xWORD:
  J.B.l=OpZ80(R->PC.W++);
  J.B.h=OpZ80(R->PC.W++);
  R->AF.B.h=cpuMemRead(J.W);
  break;

case LD_xWORD_A:
  J.B.l=OpZ80(R->PC.W++);
  J.B.h=OpZ80(R->PC.W++);
  cpuMemWrite(J.W,R->AF.B.h);
  break;

case EX_HL_xSP:
  J.B.l=cpuMemRead(R->SP.W);cpuMemWrite(R->SP.W++,R->XX.B.l);
  J.B.h=cpuMemRead(R->SP.W);cpuMemWrite(R->SP.W--,R->XX.B.h);
  R->XX.W=J.W;
  break;
