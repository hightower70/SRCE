...
typedef struct
{
  ...
  int ICount;							// CPU cycles executed since execute function is called
	int ICyclesRequested;		// CPU cycles requested when execute function is called
...
/*************************************************************/
void cpuReset(register cpuZ80State *R);
...
/*************************************************************/
void cpuInt(register cpuZ80State *R,register uint16_t in_vector);
...
/*************************************************************/
uint16_t RunZ80(register cpuZ80State *R);
...
/************************************ TO BE WRITTEN BY USER **/
#ifdef cpuZ80_PATCH_ENABLED
void cpuZ80Patch(register cpuZ80State *R);
#else
#define cpuZ80Patch(x)
#endif
...
uint8_t cpuZ80Debug(register cpuZ80State *R);
#endif
...
/************************************ TO BE WRITTEN BY USER **/
#ifdef cpuZ80_LOOP_ENABLED
uint16_t LoopZ80(register cpuZ80State *R);
#endif
